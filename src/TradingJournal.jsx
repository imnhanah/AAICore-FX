        ...
        <div className="tj-sidebar-scroll">
          ...
          <div className="tj-nav">
            ...
            <button className="tj-nav-item" onClick={() => {
              if (!window.confirm("Reset all journal data for this account? This can't be undone.")) return;
              const fresh = defaultAccounts();
              setAccounts((accs) => accs.map((a) => (a.id === activeId ? { ...fresh[0], id: a.id, name: a.name, icon: a.icon } : a)));
